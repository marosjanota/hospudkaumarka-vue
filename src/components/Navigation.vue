  ...
  <nav class="nav" :class="{ opened: burgerCheck }">
    <div class="nav__body">
      ...
      <div class="nav__items">
        <router-link to="/poledni-menu" class="nav__items--item"
          >Denní nabídka</router-link
        >
        <router-link to="/napojovy-listek" class="nav__items--item"
          >Nápojový lístek</router-link
        >
        <router-link to="/kontakt" class="nav__items--item"
          >Kontakt</router-link
        >
      </div>
